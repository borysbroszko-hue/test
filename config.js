...
const appConfig = {
    ...
    products: [
        ...
        },
        {
            ...
            price: 34.50,
            image: "assets/elfliq.png", 
            description: "Orzeźwiająca lemoniada z niebieską maliną. Lekko kwaskowaty, musujący profil smakowy idealny na każdy dzień."
        },
        {
            id: 6,
            name: "HQD | Watermelon",
        ...
        {
            id: 8,
            name: "ELFLIQ | Cotton Candy Ice",
            category: "ELFLIQ",
            price: 34.50,
            image: "assets/elfliq.png", 
            description: "Sentymentalny powrót do smaku waty cukrowej z mocnym, lodowym finiszem. Bardzo słodki i satysfakcjonujący."
        },
        {
            id: 9,
            name: "HQD | Mint",
